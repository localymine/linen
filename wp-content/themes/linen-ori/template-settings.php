<html lang="en" id="top" class=" js no-touch localstorage no-ios">
   ...
   <body class="ps-static  cms-page-view cms-template-settings">
                        ...
                        <div class="header-row">
                           <div class="header-switchers">
                              <div class="header-button lang-list full_mode">
                                 ...
                                 <ul style="">
                                    <li>
                                       <a class="selected" href="http://ld-magento.template-help.com/magento_58878/template-settings?___store=english&amp;___from_store=english" title="en_US"><span>English</span><span class="mobile-part">en</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/template-settings?___store=german&amp;___from_store=english" title="de_DE"><span>German</span><span class="mobile-part">de</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/template-settings?___store=spanish&amp;___from_store=english" title="es_ES"><span>Spanish</span><span class="mobile-part">es</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/template-settings?___store=russian&amp;___from_store=english" title="ru_RU"><span>Russian</span><span class="mobile-part">ru</span></a>
                                    </li>
                                 </ul>
                              </div>
                              <div class="header-button currency-list full_mode">
                                 ...
                                 <ul style="">
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/directory/currency/switch/currency/EUR/uenc/aHR0cDovL2xkLW1hZ2VudG8udGVtcGxhdGUtaGVscC5jb20vbWFnZW50b181ODg3OC90ZW1wbGF0ZS1zZXR0aW5ncw,,/" title="EUR"><span>€ Euro</span><span class="mobile-part">EUR</span></a>
                                    </li>
                                    <li>
                                       <a class="selected" href="http://ld-magento.template-help.com/magento_58878/directory/currency/switch/currency/USD/uenc/aHR0cDovL2xkLW1hZ2VudG8udGVtcGxhdGUtaGVscC5jb20vbWFnZW50b181ODg3OC90ZW1wbGF0ZS1zZXR0aW5ncw,,/" title="USD"><span>$ US Dollar</span><span class="mobile-part">USD</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                                 ...
                                 <table class="data-table data-table-indent">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>Testimonials</td>
                                          <td>testimonials</td>
                                          <td>sources\demo\static_blocks\testimonials.phtml</td>
                                       </tr>
                                       <tr>
                                          <td>4.</td>
                                          <td>Index block</td>
                                          <td>Index block</td>
                                          <td>index_block</td>
                                          <td>sources\demo\static_blocks\index_block.phtml</td>
                                       </tr>
                                       <tr>
                                          <td>5.</td>
                                          <td>Socials</td>
                                          <td>Socials</td>
                                          <td>socials</td>
                                          <td>sources\demo\static_blocks\socials.phtml</td>
                                       </tr>
                                       <tr>
                                          <td>6.</td>
                                          <td>Header slider</td>
                                          <td>Header slider</td>
                                          <td>header_slider</td>
                                          <td>sources\demo\static_blocks\header_slider.phtml</td>
                                       </tr>
                                    </tbody>
                                 </table>
                                 <h3><em>Widgets configuration</em></h3>
                                 <table class="data-table data-table-indent">
                                    <thead>
                                       <tr>
                                          <th>#</th>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td>1.</td>
                                          <td>Catalog New Products List</td>
                                          <td>Main Content Area</td>
                                          <td>New products grid</td>
                                          <td>1</td>
                                       </tr>
                                       <tr>
                                          <td>2.</td>
                                          <td>Blog</td>
                                          <td>AW Blog Footer</td>
                                          <td>default</td>
                                          <td>2</td>
                                       </tr>
                                    </tbody>
