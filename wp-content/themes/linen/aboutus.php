<html lang="en" id="top" class=" js no-touch localstorage no-ios">
   ...
   <body class="ps-static  cms-page-view cms-about">
                        ...
                        <div class="header-row">
                           <div class="header-switchers">
                              <div class="header-button lang-list full_mode">
                                 ...
                                 <ul style="">
                                    <li>
                                       <a class="selected" href="http://ld-magento.template-help.com/magento_58878/about?___store=english&amp;___from_store=english" title="en_US"><span>English</span><span class="mobile-part">en</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/about?___store=german&amp;___from_store=english" title="de_DE"><span>German</span><span class="mobile-part">de</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/about?___store=spanish&amp;___from_store=english" title="es_ES"><span>Spanish</span><span class="mobile-part">es</span></a>
                                    </li>
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/about?___store=russian&amp;___from_store=english" title="ru_RU"><span>Russian</span><span class="mobile-part">ru</span></a>
                                    </li>
                                 </ul>
                              </div>
                              <div class="header-button currency-list full_mode">
                                 ...
                                 <ul style="">
                                    <li>
                                       <a href="http://ld-magento.template-help.com/magento_58878/directory/currency/switch/currency/EUR/uenc/aHR0cDovL2xkLW1hZ2VudG8udGVtcGxhdGUtaGVscC5jb20vbWFnZW50b181ODg3OC9hYm91dA,,/" title="EUR"><span>€ Euro</span><span class="mobile-part">EUR</span></a>
                                    </li>
                                    <li>
                                       <a class="selected" href="http://ld-magento.template-help.com/magento_58878/directory/currency/switch/currency/USD/uenc/aHR0cDovL2xkLW1hZ2VudG8udGVtcGxhdGUtaGVscC5jb20vbWFnZW50b181ODg3OC9hYm91dA,,/" title="USD"><span>$ US Dollar</span><span class="mobile-part">USD</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                                 ...
                                 <div class="custom-page">
                                    ...
                                    <div class="skills row">
                                       <div class="col-xs-12 col-sm-4">
                                          <div class="value"><span class="number" data-finish="14500">14500</span></div>
                                          <div class="term">Products available</div>
                                       </div>
                                       <div class="col-xs-12 col-sm-4">
                                          <div class="value"><span class="number" data-finish="81">81</span>%</div>
                                          <div class="term">Clients come back</div>
                                       </div>
                                       <div class="col-xs-12 col-sm-4">
                                          <div class="value"><span class="number" data-finish="10">10</span> mlns</div>
                                    ...
                                    <div class="row a-center">
                                       <div class="col-xs-12 col-sm-4 indent1">
                                          <h4 class="custom-title1">For convenience of choice</h4>
                                       ...
                                       <div class="col-xs-12 col-sm-4 indent1">
                                          <h4 class="custom-title2">Delivery to all regions</h4>
                                    ...
                                    <div class="team row">
                                       <div class="col-xs-12 col-sm-3">
                                          <figure><a href="#" title="Robert Johnson"><img src="http://ld-magento.template-help.com/magento_58878/skin/frontend/tm_themes/theme348k/images/media/team1.jpg" alt="Robert Johnson"></a></figure>
                                          <h4><a href="#" title="Robert Johnson">Robert Johnson</a></h4>
                                          <div class="excerpt">Senior salesman with 15 years of experience. He knows everything about the products he offers.</div>
                                       </div>
                                       <div class="col-xs-12 col-sm-3">
                                          <figure><a href="#" title="JESSICA PRISTON"><img src="http://ld-magento.template-help.com/magento_58878/skin/frontend/tm_themes/theme348k/images/media/team2.jpg" alt="JESSICA PRISTON"></a></figure>
                                          <h4><a href="#" title="JESSICA PRISTON">JESSICA PRISTON</a></h4>
                                       ...
                                       <div class="col-xs-12 col-sm-3">
                                          <figure><a href="#" title="SAM KROMSTAIN"><img src="http://ld-magento.template-help.com/magento_58878/skin/frontend/tm_themes/theme348k/images/media/team3.jpg" alt="SAM KROMSTAIN"></a></figure>
                                          <h4><a href="#" title="SAM KROMSTAIN">SAM KROMSTAIN</a></h4>
                                          <div class="excerpt">Wholesale manager. Contact him if you want to buy a batch of the products offered at our store.</div>
                                       </div>
                                       <div class="col-xs-12 col-sm-3">
                                          <figure><a href="#" title="EDNA BARTON"><img src="http://ld-magento.template-help.com/magento_58878/skin/frontend/tm_themes/theme348k/images/media/team4.jpg" alt="EDNA BARTON"></a></figure>
                                          <h4><a href="#" title="EDNA BARTON">EDNA BARTON</a></h4>
                                    ...
                                    <div class="owl-testimonials testimonials owl-carousel owl-theme" style="opacity: 1; display: block;">
                                       <div class="owl-wrapper-outer">
                                          <div class="owl-wrapper" style="width: 7976px; left: 0px; display: block;">
                                             <div class="owl-item" style="width: 997px;">
