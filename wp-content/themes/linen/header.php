...
<!--[if lt IE 7 ]>
<html
    lang="en" id="top" class="no-js ie6">
    <![endif]-->
<!--[if IE 7 ]>
<html
    lang="en" id="top" class="no-js ie7">
    <![endif]-->
<!--[if IE 8 ]>
<html
    lang="en" id="top" class="no-js ie8">
    <![endif]-->
<!--[if IE 9 ]>
<html
    lang="en" id="top" class="no-js ie9">
    <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!-->
<html lang="en" id="top" class=" js no-touch localstorage no-ios">
    ...
    <head>
        ...
        <![endif]-->
        <!-- Owl Stylesheets -->
        <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/assets/js/owlcarousel/assets/owl.carousel.min.css">
        <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/assets/js/owlcarousel/assets/owl.theme.default.min.css">
        ...
        <div class="wrapper ps-static en-lang-class">
            ...
            <div class="page">
                ...
                <div class="main_site_wrapper">
                    <?php get_template_part('partials/menu', 'header') ?>